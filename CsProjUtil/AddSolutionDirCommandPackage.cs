//------------------------------------------------------------------------------
// <copyright file="AddSolutionDirCommandPackage.cs" company="Company">
...
namespace CsProjUtil
{
    ...
    {
        /// <summary>
        /// AddSolutionDirCommandPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "1b6c7e9c-8950-48c9-860c-6c7457580dc6";

        /// <summary>
        /// Initializes a new instance of the <see cref="AddSolutionDirCommand"/> class.
        /// </summary>
        public AddSolutionDirCommandPackage()
        {
